...
async def create(user_create: UserCreate, user_service: UserServiceDep):
    user = await user_service.create(user_create)
    return await user_service.get(user_id=user.id)
...
async def update(user_id: UUID4, user_update: UserUpdate, user_service: UserServiceDep):
    await user_service.update(user_id, user_update)
...
async def update_role(
    user_id: UUID4, user_update_role: UserUpdateRole, user_service: UserServiceDep
):
